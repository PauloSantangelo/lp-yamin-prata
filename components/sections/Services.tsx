    ...
    <section id="servicos" className="bg-[#fcfaf9] py-16 md:py-28 font-sans">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between mb-12 md:mb-16">
          <div className="max-w-2xl">
            <div className="flex items-start gap-4">
              ...
              />
              <div>
                <h2 className="text-3xl md:text-4xl font-light tracking-tight text-slate-800">
                  Serviços <span className="font-serif italic text-[rgb(var(--brand))]">médicos</span>
                </h2>
                <p className="mt-3 text-slate-500 leading-relaxed font-light text-base">
        ...
        <div className="grid gap-10 lg:grid-cols-12 lg:items-start mb-20 md:mb-32">
          ...
          {/* Foto: Ordem 1 no Mobile, Ordem 2 (Direita) no Desktop */}
            ...
            <div className="lg:sticky lg:top-24">
              <div className="relative overflow-hidden rounded-[35px] md:rounded-[50px] bg-white shadow-xl shadow-slate-200/50">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 text-white">
                  ...
                  <p className="text-xs opacity-80 font-light tracking-wide uppercase">CRM-SP: 178037 | RQE: 79913</p>
                </div>
              </div>
            </div>
          </div>

          {/* Cards: Ordem 2 no Mobile, Ordem 1 (Esquerda) no Desktop */}
                ...
                >
                  <div className="flex flex-col h-full">
                    ...
                    <div className="mt-auto pt-4 flex items-center gap-2">
                      ...
                      <span className="text-[10px] text-slate-400 italic">Plano individualizado</span>
                    </div>
                  </div>
                </div>
              ))}
        ...
        <div className="border-t border-slate-200 pt-16">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 font-light text-sm">
              Emitimos nota fiscal detalhada para facilitar seu reembolso nos principais planos:
            </p>
          </div>

          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16">
            {CONVENIOS.map((logo) => (
              <div key={logo.name} className="relative w-24 h-10 md:w-28 md:h-12">
                <Image
                  src={logo.src}
                  alt={logo.name}
                  fill
